...
export class AppPasswordResetComponent {
  ...
  containerClasses = 'flex items-center justify-center min-h-screen  bg-cover bg-center bg-no-repeat ';
  cardClasses = 'bg-card p-5 rounded-xl shadow-2xl max-w-[300px] sm:max-w-xs md:max-w-sm w-full bg-white ';
